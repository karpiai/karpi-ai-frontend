...
const Registration = ({ onRegisterSuccess }: Props) => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        // Ensure the keys match what your Backend Controller returns:
        // collegeName and studentName
        const userData = {
        ...
        localStorage.setItem("karpi_user", JSON.stringify(userData));
        ...
        <form onSubmit={handleRegister} className="p-8 space-y-5">
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  setRegData({ ...regData, rollNo: e.target.value })
                }
              />
            </div>
            ...
            <div className="bg-cyan-50 p-4 rounded-xl border border-cyan-100">
              ...
              <input
                ...
                onChange={(e) =>
                  setRegData({ ...regData, accessCode: e.target.value })
                }
              />
            </div>
          </div>
          ...
          >
            {loading ? (
              ...
              <>
                Access AI Tools <CheckCircle2 size={20} />
              </>
            )}
          </button>
        </form>
